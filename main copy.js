...
// autoStart for quick testing
function autoStart_pose()
{
  socket_pose = new WebSocket('ws://192.168.8.161:4103/pose')
  socket_pose.onmessage = function(e)
  {
    socket_onmessage_callback(e.data);
  }
...
// autoStart_hands
function autoStart_hands()
{
  socket_hands = new WebSocket('ws://192.168.8.161:4103/hands')
...
function onResults_hands(results) {
 ...
 // canvasCtx_hands.drawImage(
   //   results.image, 0, 0, canvasElement_hands.width, canvasElement_hands.height);
